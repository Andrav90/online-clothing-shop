...
function About() {
    return(
        <Layout>
            <div className="about">
                <h1 className="d-flex flex-column align-items-center">About</h1>
